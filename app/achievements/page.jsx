      ...
      <div className="max-w-5xl mx-auto space-y-8 animate-fade-in opacity-0 [animation-delay:300ms]">
        {achievements.map((item) => (
          <Link 
            ...
            className="block"
          >
            <div className="relative flex flex-col md:flex-row bg-ers-dark border border-white/10 hover:border-ers-yellow/50 transition-all p-6 md:p-8 gap-6 group cursor-pointer hover:bg-white/5">
